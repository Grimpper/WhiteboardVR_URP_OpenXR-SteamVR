...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_spice_gun p_spice_gun;
        ...
        public static SteamVR_Input_ActionSet_spice_gun spice_gun
        {
            get
            {
                return SteamVR_Actions.p_spice_gun.GetCopy<SteamVR_Input_ActionSet_spice_gun>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_spice_gun = ((SteamVR_Input_ActionSet_spice_gun)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_spice_gun>("/actions/spice_gun")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.spice_gun};
        }
    }
}
